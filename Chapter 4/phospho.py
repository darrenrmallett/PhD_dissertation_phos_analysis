...
version = '1.1 [Version 1 with SVG and PSM count extension]'

print(f'Running: Version {version}')
print('Initializing... please wait...')

import os, sys, filereader as fr, urllib.parse, mass_spec as ms, re, proteins, compare_files, time, pprint as pp
