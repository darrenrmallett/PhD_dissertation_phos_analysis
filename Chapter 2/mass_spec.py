...
class MassSpec:
    ...
    def mods(self, mod_column, protein, peptide, mods_in_master, minimum_confidence):
        ...
        mods_in_master = mods_in_master #this is a True or False. True = the modification info refers to residues in the master protein. False = refers to residues in the PEPTIDE. If this is false, we have to match the residue in the peptide to the residue in the master protein.
                    ...
                    if 'Annotated Sequence' in line or 'Modifications' in line:
                        ...
                        if contaminant_protein is False:
                            ...
                            if peptide is not None and peptide.groups()[0] in self.proteins[last_protein]['peptides'].keys():
                                ...
                                #this peptide does not exist already. add it and its position in protein, along with it's PSM count (if greater than cutoff), as well as mods if it has any.
                    ...
                    if unique_peptide_mod is not None:
                        ...
                        for mod_type, mod_info in unique_peptide_mod.items():
                            ...
                            if mod_type == 'phos':
                                ...
                                #get amino acid and position, and PSMs for that unique peptide for each phosphorylation
